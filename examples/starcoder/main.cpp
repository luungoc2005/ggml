...
bool starcoder_model_load(const std::string & fname, starcoder_model & model, gpt_vocab & vocab) {
    ...
    // key + value memory
    {
        ...
        fprintf(stderr, "%s: memory size = %8.2f MB, n_mem = %d\n", __func__, memory_size/1024.0/1024.0, n_mem);
    }
